          ...
          <div class="uk-grid-small" uk-grid>
              <div class="uk-width-2-5@m uk-flex uk-flex-middle">
                <ul class="uk-navbar-nav">
                  <li class="uk-margin-medium-right {{ $navigation == 'mens' ? 'uk-active' : ''}}"><a class="menu-header" href="{{ route('men') }}"> {{ trans('app.men') }} </a></li>
                  <li class="{{ $navigation == 'womens' ? 'uk-active' : ''}}"><a class="menu-header" href="{{ route('women') }}"> {{ trans('app.women') }} </a></li>
                </ul>
