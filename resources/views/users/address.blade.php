            ...
            <div id="modal-sections" uk-modal>
              <div class="uk-modal-dialog">
                ...
                <div class="uk-modal-footer uk-text-right">
                  <button class="uk-button uk-button-default uk-modal-close" type="button">{{ trans('app.cancel') }}</button>
                  <button class="uk-button uk-button-secondary" id="modal-submit">{{ trans('app.save') }}</button>
                </div>
              </div>
            </div>
            <address-list
