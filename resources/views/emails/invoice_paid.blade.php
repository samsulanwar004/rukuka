...
<head>
    ...
    <title>{{trans('app.paid_subject',[], $locale)}}</title>
    <style type="text/css">
                                            ...
                                            <table cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    <td valign="middle" style="vertical-align:middle; padding-right: 15px; padding-left: 15px; text-align:left;" class="mobile-center font-white" height="303">
                                                        <h1 class="font-white">{{ trans('app.paid_subject',[], $locale) }}</h1><br>
                                                        <h2 class="font-white">{{ trans('app.paid_subtitle_1',[], $locale) }}<br>{{ trans('app.paid_subtitle_2',[], $locale) }}</h2>
                                                        <br>
                                                    </td>
                                                </tr>
                                            </table>
