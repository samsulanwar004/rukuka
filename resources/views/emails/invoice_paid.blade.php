...
<head>
    ...
    <title>{{trans('app.paid_subject')}}</title>
    <style type="text/css">
            ...
            <table cellspacing="0" cellpadding="0" width="100%">
                                            ...
                                            <table cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    <td valign="middle" style="vertical-align:middle; padding-right: 15px; padding-left: 15px; text-align:left;" class="mobile-center font-white" height="303">
                                                        <h1 class="font-white">{{ trans('app.paid_subject') }}</h1><br>
                                                        <h2 class="font-white">{{ trans('app.paid_subtitle_1') }}<br>{{ trans('app.paid_subtitle_2') }}</h2>
                                                        <br>
                                                    </td>
                                                </tr>
                                            </table>
                                ...
                                <tr>
                                    <td class="mobile-padding">
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="100%">
                                            ...
                                            <tr>
                                                <td style="text-align: left;">
                                                    {{ trans('app.paid_text_1') }}
                                                    <br>{{ trans('app.paid_text_2') }}
                                                    <br>
                                                    <br>
                                                </td>
                                            </tr>
                ...
                <tr>
                    <td style="background-color:#F8F8F8;">
                        <center>
                            <table cellspacing="0" cellpadding="40" width="500" class="w320">
                                <tr>
                                    <td>
                                        <center>
