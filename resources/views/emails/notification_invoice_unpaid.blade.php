                    ...
                    <tr>
                      <td style="word-wrap:break-word;padding:10px 25px;" align="center">
                        <div style="cursor:auto;color:#333;font-size:22px;line-height:22px;text-align:center;font-weight:800">
                          {{ trans('app.notification_unpaid_title',[], $locale) }}
                        </div>
                      </td>
                    </tr>
                  </tbody>
                        ...
                        <div class="mj-column-per-100 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%;">
                          <table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                            <tbody>
                              ...
                              <tr>
                                <td style="word-wrap:break-word;padding:10px 25px;" align="left">
                                  @component('mail::button', ['url' => CRUDBooster::adminPath().'/orders/detail/'.$order->id.'?return_url=/admin/orders'])
                                      {{ trans('app.notification_button_order',[], $locale) }}
                                  @endcomponent
                                </td>
                              </tr>
                            </tbody>
