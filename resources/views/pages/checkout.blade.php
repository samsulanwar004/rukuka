    ...
    <div class="uk-width-3-4@m">
      ...
      <div class="uk-grid uk-width-1-2@m">
        <div class="uk-grid uk-grid-small uk-child-width-1-2@m uk-text-meta" uk-grid>
          <div>
            First Name *
            <input type="text" name="" value="" class="uk-input uk-form-small">
          </div>
          <div>
            Last Name *
            <input type="text" name="" value="" class="uk-input uk-form-small">
        ...
        <div class="uk-text-meta uk-margin-small-top">
          Postal Code *
          <input type="text" name="" value="" class="uk-input uk-form-small uk-from-width-small">
        </div>
        <div class="uk-text-meta uk-margin-small-top">
          Phone Number *
          <input type="text" name="" value="" class="uk-input uk-form-small uk-from-width-small">
        ...
        <div class="uk-text-meta uk-margin-small-top">
          <input type="checkbox" class="uk-checkbox" name="" value=""> This address is also my billing address

          <p> <b>* Required</b> </p>
        </div>
        <div class="uk-text-meta uk-margin-small-top uk-width-1-1">
          <input type="submit" name="" value="C O N T I N U E" class="uk-button-danger uk-button uk-button-small uk-width-1-1">
        </div>
      </div>
    </div>
