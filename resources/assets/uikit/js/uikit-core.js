...
function preventClick() {
    ...
    var timer = setTimeout(once(doc, 'click', function (e) {
...
var Container = {
    ...
    computed: {
        ...
        container: function container(ref) {
            ...
            return container === true && UIkit$1.container || container && $(container);
        }
...

            {
                ...
                handler: function handler() {
                    ...
                    target[isInput(target) ? 'value' : 'textContent'] = input.files && input.files[0]
                        ? input.files[0].name
                        : matches(input, 'select') && ((assign = $$('option', input).filter(function (el) { return el.selected; }), option = assign[0], assign))
                            ? option.textContent
                            : input.value;
                }
