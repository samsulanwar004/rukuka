...
class NotificationInvoicePaid extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->markdown('emails.notification_invoice_paid', [
            'order' => $this->unpaid(), 'locale' => $this->lang
        ])
            ->subject(trans('app.notification_paid_subject',[], $this->lang).'-'.$this->order->order_code);
    }
