<?php namespace App\Http\Controllers;
	...
	class AdminLookbooksController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ['label'=>'Banner','name'=>'banner','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
