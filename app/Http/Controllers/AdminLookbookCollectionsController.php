<?php namespace App\Http\Controllers;
	...
	class AdminLookbookCollectionsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Name','name'=>'name','type'=>'text','validation'=>'required|string|unique:lookbook_collections','width'=>'col-sm-10','placeholder'=>'You can only enter the letter only'];
			...
			$this->form[] = ['label'=>'Photo','name'=>'photo','type'=>'upload','width'=>'col-sm-10','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP', 'upload_encrypt'=>'true'];
